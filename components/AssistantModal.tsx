...
export function AssistantModal({ visible, onClose }: AssistantModalProps) {
  ...
  return (
    <AnimatedModal visible={visible} transparent onRequestClose={onClose} statusBarTranslucent>
      ...
      >
        <Pressable
          style={{ alignSelf: "center", width: "92%", maxWidth: 560, maxHeight: "92%", backgroundColor: C.surface, borderColor: C.border, borderWidth: 1, borderRadius: 16, overflow: "hidden" }}
        ...
        >
          <View style={{ flexDirection: "row", alignItems: "center", paddingHorizontal: 18, paddingVertical: 14, borderBottomWidth: 1, borderBottomColor: C.border }}>
            ...
            <Pressable onPress={onClose} hitSlop={12} accessibilityRole="button" accessibilityLabel={t("a11y", "closeModal")} testID="assistant-close">
              <Ionicons name="close" size={22} color={C.textSecondary} />
            </Pressable>
          </View>
          <ScrollView contentContainerStyle={{ padding: 18, paddingBottom: 28 }} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
