...
- **Highest-risk code areas:** `server/routes.ts`, `lib/backup.ts`, `lib/pending-import.ts`, `components/SignalGeneratorModal.tsx`, `components/MicWebView.tsx`, `lib/practice-room.ts`, `lib/audio-renderer.ts`
