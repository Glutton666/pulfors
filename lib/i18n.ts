...
export const translations = {
  ...
  drumKit: {
    ...
    save: { ko: "저장", en: "Save" },
    saved: { ko: "연습장에 저장됨", en: "Saved to Practice Note" },
    nameLabel: { ko: "이름", en: "Name" },
    namePlaceholder: { ko: "드럼 루프", en: "Drum Loop" },
    micPermissionDenied: { ko: "마이크 권한이 필요합니다", en: "Microphone permission required" },
    nothingRecorded: { ko: "녹음된 패드가 없습니다", en: "No pads were triggered" },
    preview: { ko: "미리듣기", en: "Preview" },
    discard: { ko: "버리기", en: "Discard" },
    pickerError: { ko: "파일을 가져올 수 없습니다", en: "Could not import file" },
    recordingHint: { ko: "패드를 누르면 16분음 격자로 자동 정렬됩니다", en: "Pad hits snap to a 16th-note grid" },
