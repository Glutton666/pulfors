...
const translations = {
  settings: {
    ...
    micMethod: { ko: "마이크 감지 방식", en: "Mic Detection Method" },
    micMethodNative: { ko: "네이티브 (기본)", en: "Native (Default)" },
    micMethodWebView: { ko: "WebView (대체)", en: "WebView (Fallback)" },
    micMethodHint: { ko: "신호 생성기의 마이크 튜너에 사용됩니다. 네이티브가 작동하지 않으면 WebView로 전환하세요", en: "Used by the signal generator mic tuner. Switch to WebView if native doesn't work" },
