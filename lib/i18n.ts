...
export const translations = {
  ...
  tempoQuiz: {
    title: { ko: "BPM 퀴즈", en: "Tempo Quiz" },
    menuHint: { ko: "들려주는 박자의 BPM을 추측해 보세요", en: "Guess the tempo you hear" },
    difficulty: { ko: "난이도", en: "Difficulty" },
    easy: { ko: "쉬움 (60–120)", en: "Easy (60–120)" },
    normal: { ko: "보통 (60–180)", en: "Normal (60–180)" },
    hard: { ko: "어려움 (40–220)", en: "Hard (40–220)" },
    startQuiz: { ko: "문제 시작", en: "Start Quiz" },
    listening: { ko: "재생 중...", en: "Listening..." },
    measureProgress: { ko: "%cur / %total 마디", en: "%cur / %total measures" },
    yourGuess: { ko: "BPM 추측", en: "Your Guess" },
    submit: { ko: "제출", en: "Submit" },
    replay: { ko: "다시 듣기", en: "Replay" },
    answer: { ko: "정답", en: "Answer" },
    yourAnswer: { ko: "당신의 답", en: "Your Answer" },
    diff: { ko: "오차", en: "Diff" },
    gradePerfect: { ko: "완벽", en: "Perfect" },
    gradeGood: { ko: "양호", en: "Good" },
    gradeFail: { ko: "실패", en: "Fail" },
    next: { ko: "다음 문제", en: "Next" },
    close: { ko: "닫기", en: "Close" },
  },
  noteMode: {
