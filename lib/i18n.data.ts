...
export const translations = {
  ...
  stemSep: {
    ...
    formatErrorTitle: { ko: "지원하지 않는 파일 형식", en: "Unsupported File Format" },
    formatErrorBody:  { ko: "WAV, MP3, M4A, AAC 파일만 가져올 수 있습니다.", en: "Only WAV, MP3, M4A, and AAC files can be imported." },
