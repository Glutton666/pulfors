// ============================================================
// i18n.data.ts — 번역 객체 전용 파일
// 런타임 로직 없음 (언어 감지·t()·누락 보고는 i18n.ts에 있음).
// ============================================================
...
export const translations = {
  settings: {
    ...
    barMetronomeChannel: { ko: "메트로놈 채널", en: "Metronome Channel" },
    barMetronomeChannelHint: { ko: "메트로놈 클릭이 들리는 채널입니다 (스테레오 출력 시).", en: "Channel for metronome clicks (stereo output only)." },
    barCellOpacity: { ko: "바 셀 오버레이 투명도", en: "Bar Cell Overlay Opacity" },
    barCellOpacityHint: { ko: "음표 표시가 꺼졌을 때 색상 셀의 불투명도입니다", en: "Opacity of colored cells when staff notation is off" },
    barStaffNotation: { ko: "오선과 음표로 표시", en: "Show Staff and Notes" },
    barStaffNotationHint: { ko: "켜면 오선과 음표를 표시하고, 끄면 색상 셀로 표시합니다", en: "Show staff notation when on, or colored cells when off" },
    beatStaff: { ko: "비트 오선 표시", en: "Beat staff" },
    beatStaffHint: { ko: "비트 모드를 오선 셀로 표시합니다", en: "Show Beat mode as staff cells" },
    ...
    toneResonance: { ko: "공명", en: "Resonance" },
    toneLow: { ko: "저음", en: "Low" },
    toneNeutral: { ko: "중립", en: "Neutral" },
    toneReset: { ko: "중앙으로 초기화", en: "Reset to center" },
    soundFaderAccessibility: { ko: "메트로놈 사운드 페이더 조절", en: "Adjust metronome sound fader" },
    ...
    showTutorialAgain: { ko: "모드 튜토리얼 다시 보기", en: "Replay Mode Tutorial" },
    showTutorialAgainHint: { ko: "현재 화면의 기능 안내를 다시 봅니다", en: "Replay the tutorial for the current mode" },
    resetTutorials: { ko: "모드 튜토리얼 상태 초기화", en: "Reset Mode Tutorials" },
    ...
    restoreRolledBack: { ko: "복원 중 문제가 발생했지만 기존 데이터는 안전하게 되돌렸습니다. 파일을 확인한 뒤 다시 시도하세요.", en: "Restore could not finish, but your existing data was restored safely. Check the file and try again." },
    restoreRecoveryPending: { ko: "복원 중 문제가 발생했습니다. 기존 데이터를 보호하기 위해 앱을 다시 시작해 자동 복구하세요.", en: "Restore could not finish. Restart the app to safely recover your existing data." },
    restoreRetry: { ko: "다시 시도", en: "Try Again" },
  ...
  soundSets: {
    ...
    sine: { ko: "사인파", en: "Sine" },
    blip: { ko: "블립", en: "Blip" },
    clave: { ko: "클라베", en: "Clave" },
    cajon: { ko: "카혼", en: "Cajon" },
    marimba: { ko: "마림바", en: "Marimba" },
    stick: { ko: "스틱", en: "Stick" },
    kick: { ko: "킥", en: "Kick" },
  ...
  onboarding: {
    ...
    back: { ko: "이전", en: "Back" },
    backHint: { ko: "이전 온보딩 단계로 돌아갑니다", en: "Go back to the previous onboarding step" },
    skipHint: { ko: "선택 설정을 건너뛰고 메트로놈을 바로 엽니다", en: "Skip optional setup and open the metronome" },
    nextHint: { ko: "다음 온보딩 단계로 이동합니다", en: "Go to the next onboarding step" },
    startHint: { ko: "온보딩을 끝내고 메트로놈을 엽니다", en: "Finish onboarding and open the metronome" },
    stepProgress: { ko: "진행 단계", en: "Onboarding progress" },
    quickStartTitle: { ko: "바로 시작할 준비가 됐어요", en: "Ready to start" },
    quickStartSubtitle: { ko: "나머지 설정은 나중에 언제든지 바꿀 수 있습니다", en: "You can change the other settings anytime" },
    quickStartBody: { ko: "이제 메트로놈을 바로 사용할 수 있습니다", en: "You can start using the metronome now" },
    quickStartHint: { ko: "테마, 기록, 햅틱, 플래시, 프로필과 권한은 설정에서 나중에 조정할 수 있어요.", en: "Theme, logging, haptics, flash, profile, and permissions can be adjusted later in Settings." },
    ...
    soundTestPlayHint: { ko: "클릭 소리가 들리는지 확인합니다", en: "Check whether you can hear the click" },
    soundTestMuteHint: { ko: "소리가 안 들리면 무음 스위치(iOS) 또는 볼륨 설정을 확인하세요", en: "No sound? Check the mute switch (iOS) or your volume level" },
    soundTestFailed: { ko: "소리를 재생하지 못했습니다. 시작한 뒤 사운드 설정에서 다시 시도할 수 있어요.", en: "The sound could not be played. You can try again after starting from Sound settings." },
  ...
  tutorial: {
    modeTitle: { ko: "모드 튜토리얼", en: "Mode tutorial" },
    beat: { ko: "비트", en: "Beat" },
    bar: { ko: "바", en: "Bar" },
    note: { ko: "노트", en: "Note" },
    ...
    beatTapBody: { ko: "손가락으로 일정하게 여러 번 탭해 현재 템포를 측정해보세요.", en: "Tap steadily several times to measure the current tempo." },
    beatPlayTitle: { ko: "재생을 시작해보세요", en: "Start playback" },
    beatPlayBody: { ko: "재생 버튼을 눌러 비트가 어떻게 들리고 표시되는지 확인해보세요.", en: "Press Play to hear and see the beat in action." },
    barEditTitle: { ko: "바를 편집해보세요", en: "Edit a bar" },
    barEditBody: { ko: "바 셀을 탭하거나 길게 눌러 박자와 반복 설정을 바꿔보세요.", en: "Tap or long-press a bar cell to change its beat and repeat settings." },
    barAddTitle: { ko: "바를 추가해보세요", en: "Add a bar" },
    barAddBody: { ko: "바 화면의 추가 동작을 사용해 연습 패턴을 한 마디 늘려보세요.", en: "Use the add-bar action to extend your practice pattern by one measure." },
    barPlayTitle: { ko: "바 재생을 시작해보세요", en: "Play the bar pattern" },
    barPlayBody: { ko: "재생을 눌러 편집한 바 패턴을 들어보세요.", en: "Press Play to hear the bar pattern you edited." },
    noteQueueTitle: { ko: "노트를 연습장에 넣어보세요", en: "Add a note to the queue" },
    noteQueueBody: { ko: "연습장 항목에서 노트 큐에 하나를 추가해보세요.", en: "Add an item from the practice list to the note queue." },
    notePlayTitle: { ko: "노트 큐를 재생해보세요", en: "Play the note queue" },
    notePlayBody: { ko: "재생 버튼을 눌러 큐의 항목을 순서대로 연습해보세요.", en: "Press Play to practice the queued items in order." },
    practiceOpenTitle: { ko: "연습장을 열어보세요", en: "Open the practice book" },
    practiceOpenBody: { ko: "모드 다이얼에서 연습장을 선택해 저장된 연습 패턴을 확인해보세요.", en: "Choose Practice from the mode dial to see saved practice patterns." },
    practiceLoadTitle: { ko: "연습 패턴을 불러와보세요", en: "Load a practice pattern" },
    practiceLoadBody: { ko: "목록에서 항목을 열어 현재 모드에 적용해보세요.", en: "Open an item from the list to apply it to the current mode." },
  },
  errorFallback: {
    title: { ko: "앱에 문제가 발생했습니다", en: "Something went wrong" },
    message: { ko: "다시 시도하거나 홈으로 돌아가 계속 사용할 수 있습니다.", en: "Try again or return home to continue using the app." },
    dataSafe: { ko: "저장된 설정과 연습 데이터는 이 오류 화면 때문에 삭제되지 않습니다.", en: "Your saved settings and practice data are not deleted by this error." },
    retry: { ko: "다시 시도", en: "Try Again" },
    retrying: { ko: "다시 시작하는 중…", en: "Restarting…" },
    retryHint: { ko: "앱을 다시 불러옵니다", en: "Reload the app" },
    home: { ko: "홈으로 돌아가기", en: "Return Home" },
    homeHint: { ko: "오류 화면을 닫고 기본 화면으로 돌아갑니다", en: "Dismiss the error screen and return to the default screen" },
    details: { ko: "오류 세부 정보 보기", en: "View error details" },
    closeDetails: { ko: "오류 세부 정보 닫기", en: "Close error details" },
  },
  stopwatchTimer: {
  ...
  signalGenerator: {
    ...
    micNoInput: { ko: "마이크 입력을 받지 못했습니다", en: "No microphone input received" },
    micPermissionRequired: { ko: "마이크 권한이 필요합니다", en: "Microphone permission is required" },
    micStartFailed: { ko: "마이크를 시작할 수 없습니다", en: "Could not start the microphone" },
    hzUnit: { ko: "Hz", en: "Hz" },
    ...
    closeHint: { ko: "시그널 제너레이터를 닫습니다", en: "Close the signal generator" },
    clearTarget: { ko: "목표 음 지우기", en: "Clear target note" },
    clearTargetHint: { ko: "설정한 목표 음을 지웁니다", en: "Clear the selected target note" },
    ...
    analysisTitle: { ko: "10초 음향 분석", en: "10-second sound analysis" },
    analysisReady: { ko: "감지할 준비가 되었습니다", en: "Ready to listen" },
    analysisReadyHint: { ko: "주변 소리를 최대 10초 동안 기록하고 음별 비중을 분석합니다.", en: "Record up to 10 seconds and analyze the balance of detected notes." },
    analysisStart: { ko: "감지 시작", en: "Start detection" },
    analysisRecording: { ko: "소리를 듣고 있습니다", en: "Listening" },
    analysisRecordingHint: { ko: "완료를 누르거나 10초가 지나면 결과가 표시됩니다.", en: "Tap Done or wait for the 10-second recording to finish." },
    analysisFinish: { ko: "완료", en: "Done" },
    analysisCancel: { ko: "감지 모드 닫기", en: "Close analysis mode" },
    analysisResult: { ko: "분석 결과", en: "Analysis result" },
    analysisDragHint: { ko: "드래그하여 이동", en: "Drag to seek" },
    analysisAudioReady: { ko: "원본 소리 다시듣기 가능", en: "Original audio available" },
    analysisAudioUnavailable: { ko: "다시듣기 오디오 없음", en: "Replay audio unavailable" },
    analysisReplay: { ko: "다시듣기", en: "Replay" },
    analysisPause: { ko: "일시정지", en: "Pause" },
    analysisDistribution: { ko: "음별 비중", en: "Note distribution" },
    analysisTimelineTitle: { ko: "시간별 감지", en: "Timeline" },
    analysisNoNotes: { ko: "뚜렷한 음을 감지하지 못했습니다", en: "No distinct notes detected" },
    analysisSilence: { ko: "무음 또는 불명확", en: "Silence or unclear" },
    analysisAgain: { ko: "다시 감지하기", en: "Analyze again" },
  },
  pitchQuiz: {
    chooseTitle: { ko: "음감 퀴즈", en: "Pitch Quiz" },
    chooseHint: { ko: "어떤 방식으로 들을까요?", en: "How would you like to listen?" },
    absolute: { ko: "절대음감", en: "Absolute Pitch" },
    relative: { ko: "상대음감", en: "Relative Pitch" },
    chord: { ko: "화음 맞추기", en: "Chord Match" },
    listen: { ko: "소리를 듣고 맞혀보세요", en: "Listen and choose" },
    relativePrompt: { ko: "두 음 사이의 간격은 몇 반음일까요?", en: "How many semitones are between the two notes?" },
    absolutePrompt: { ko: "들린 음의 계이름은 무엇일까요?", en: "Which note name did you hear?" },
    chordPrompt: { ko: "동시에 울린 화음의 종류는 무엇일까요?", en: "What kind of chord did you hear?" },
    replay: { ko: "다시 듣기", en: "Replay" },
    giveUp: { ko: "포기", en: "Give Up" },
    correct: { ko: "정답!", en: "Correct!" },
    answer: { ko: "정답", en: "Answer" },
    close: { ko: "닫기", en: "Close" },
    resultsTitle: { ko: "이번 결과", en: "Your Results" },
    accuracy: { ko: "정확도 {value}%", en: "{value}% accuracy" },
    bestStreak: { ko: "최고 연속정답 {value}", en: "Best streak: {value}" },
    interval1: { ko: "반음", en: "1 semitone" },
    interval2: { ko: "2반음", en: "2 semitones" },
    interval3: { ko: "3반음", en: "3 semitones" },
    interval4: { ko: "4반음", en: "4 semitones" },
    interval5: { ko: "5반음", en: "5 semitones" },
    interval6: { ko: "6반음", en: "6 semitones" },
    interval7: { ko: "7반음", en: "7 semitones" },
    interval8: { ko: "8반음", en: "8 semitones" },
    interval9: { ko: "9반음", en: "9 semitones" },
    interval10: { ko: "10반음", en: "10 semitones" },
    interval11: { ko: "11반음", en: "11 semitones" },
    interval12: { ko: "옥타브", en: "Octave" },
    chordMajor: { ko: "장3화음", en: "Major triad" },
    chordMinor: { ko: "단3화음", en: "Minor triad" },
    chordDiminished: { ko: "감화음", en: "Diminished triad" },
    chordAugmented: { ko: "증화음", en: "Augmented triad" },
    chordDominant7: { ko: "딸림7화음", en: "Dominant seventh" },
  },
  tuner: {
    title: { ko: "튜너", en: "Tuner" },
    menuHint: { ko: "마이크로 음정을 감지하고 튜닝합니다", en: "Detect and tune pitch using microphone" },
    micOff: { ko: "마이크 끄기", en: "Mic Off" },
    micOn: { ko: "마이크 켜기", en: "Mic On" },
    reference: { ko: "기준음 (Hz)", en: "Reference (Hz)" },
    pitchHigh: { ko: "높음", en: "High" },
    pitchLow: { ko: "낮음", en: "Low" },
    tuningGuide: { ko: "튜닝 가이드", en: "Tuning Guide" },
    tapToSet: { ko: "탭하여 목표 음 설정", en: "Tap to set target note" },
  ...
  noteRecorder: {
    ...
    sampleSlots: { ko: "샘플 ({0}/3)", en: "Samples ({0}/3)" },
    sampleSlotSaved: { ko: "샘플 {0} (저장됨)", en: "Sample {0} (saved)" },
    sampleSlotEmpty: { ko: "샘플 {0} (빈 슬롯)", en: "Sample {0} (empty slot)" },
    editSample: { ko: "이 샘플 편집", en: "Edit this sample" },
    record: { ko: "녹음", en: "Record" },
    ...
    tapTempo: { ko: "탭 템포", en: "Tap tempo" },
    tapTempoHint: { ko: "박자에 맞춰 두 번 이상 탭하세요", en: "Tap at least twice with the beat" },
    tapTempoAccessibility: { ko: "샘플 미리듣기 탭 템포", en: "Tap tempo for sample preview" },
  ...
  main: {
    ...
    beatQuickSaveTitle: { ko: "연습장에 저장", en: "Save to Practice Note" },
    beatQuickSaveConfirm: { ko: "저장", en: "Save" },
    beatQuickSaveNamePlaceholder: { ko: "이름 (예: 120 BPM)", en: "Name (e.g. 120 BPM)" },
    ...
    beatStaffHint: { ko: "패턴을 셀에 드래그 · 오른쪽으로 스와이프하여 추가", en: "Drag a pattern to a cell · swipe right to add" },
    beatStaffAdd: { ko: "비트 추가", en: "Add beat" },
    play: { ko: "재생", en: "Play" },
    stop: { ko: "정지", en: "Stop" },
  ...
  noteMode: {
    ...
    loadSources: { ko: "연습장에서 불러오기", en: "Load from practice book" },
    sourceInviteHint: { ko: "필터와 검색으로 연습 항목을 골라 큐를 만드세요", en: "Search and filter entries to build your queue" },
    selected: { ko: "개 선택됨", en: "selected" },
    searchSources: { ko: "항목 검색", en: "Search practice entries" },
    filterAll: { ko: "전체", en: "All" },
    filterBeat: { ko: "비트", en: "Beat" },
    filterBar: { ko: "바", en: "Bar" },
    filterScore: { ko: "악보", en: "Score" },
    noSources: { ko: "조건에 맞는 항목이 없습니다", en: "No matching practice entries" },
    loadSelected: { ko: "선택 항목 불러오기", en: "Load selected" },
    framePhoto: { ko: "사진 프레임 조정", en: "Frame photo" },
    frameHint: { ko: "보이는 구도를 맞추고 연습에 집중하세요", en: "Set the view you want to see while practicing" },
    frameSize: { ko: "프레임", en: "Frame" },
    frameTaller: { ko: "프레임을 세로로 늘리기", en: "Make frame taller" },
    frameWider: { ko: "프레임을 가로로 늘리기", en: "Make frame wider" },
    matchScreen: { ko: "화면 맞춤", en: "Match screen" },
    zoom: { ko: "확대", en: "Zoom" },
    zoomOut: { ko: "사진 축소", en: "Zoom photo out" },
    zoomIn: { ko: "사진 확대", en: "Zoom photo in" },
    moveLeft: { ko: "사진을 왼쪽으로 이동", en: "Move photo left" },
    moveRight: { ko: "사진을 오른쪽으로 이동", en: "Move photo right" },
    moveUp: { ko: "사진을 위로 이동", en: "Move photo up" },
    moveDown: { ko: "사진을 아래로 이동", en: "Move photo down" },
    removePhoto: { ko: "사진 제거", en: "Remove photo" },
    applyFrame: { ko: "프레임 적용", en: "Apply frame" },
  },
  duration: {
    s: { ko: "초", en: "s" },
    m: { ko: "분", en: "m" },
  ...
  drumKit: {
    ...
    cancel: { ko: "취소", en: "Cancel" },
    close: { ko: "닫기", en: "Close" },
    closeHint: { ko: "드럼 패드를 닫습니다", en: "Close the drum pad" },
    recording: { ko: "녹음 중", en: "Recording" },
  ...
  keyboard: {
    ...
    sectionNote:        { ko: "노트 모드", en: "Note Mode" },
    ...
    actionApplySubdivision: { ko: "현재 서브디비전을 마지막 박자에 적용", en: "Apply Subdivision to Last Beat" },
    actionBarPrevious:  { ko: "이전 바 선택", en: "Select Previous Bar" },
    actionBarNext:      { ko: "다음 바 선택", en: "Select Next Bar" },
    actionBarBlock:     { ko: "블록 시작 / 완성", en: "Start / Finish Block" },
    actionBarRepeat:    { ko: "반복 설정", en: "Set Repeat" },
    actionBarJumpFrom:  { ko: "점프 출발지", en: "Set Jump Source" },
    actionBarJumpTo:    { ko: "점프 목적지", en: "Set Jump Destination" },
    actionBarVolta:     { ko: "N회 부호", en: "Set Nth-time Ending" },
    actionBarEnd:       { ko: "끝 부호", en: "Toggle End Mark" },
    actionBarCopy:      { ko: "선택한 바 복사", en: "Copy Selected Bar" },
    actionBarPaste:     { ko: "복사한 바 붙여넣기", en: "Paste Copied Bar" },
    actionBarRepeatMode:{ ko: "횟수 / 시간 전환", en: "Toggle Count / Time" },
    actionBarAddLayer:  { ko: "폴리리듬 레이어 추가", en: "Add Polyrhythm Layer" },
    actionBarQuickSave: { ko: "바 구성 저장", en: "Save Bar Setup" },
    actionBarOpenAudio: { ko: "오디오·샘플 선택", en: "Choose Audio / Sample" },
    actionBarRemoveSubdivision: { ko: "마지막 서브디비전 삭제", en: "Remove Final Subdivision" },
    actionBarConfirm:   { ko: "바 추가 / 편집 완료", en: "Add Bar / Finish Editing" },
    actionNoteNext:     { ko: "다음 큐 항목", en: "Next Queue Item" },
  },
  barModeView: {
    ...
    ssJamblock:         { ko: "잼블록", en: "Jamblock" },
    ssSine:             { ko: "사인파", en: "Sine" },
    ssBlip:             { ko: "블립", en: "Blip" },
    ssClave:            { ko: "클라베", en: "Clave" },
    ssCajon:            { ko: "카혼", en: "Cajon" },
    ssMarimba:          { ko: "마림바", en: "Marimba" },
    ssStick:            { ko: "스틱", en: "Stick" },
    ...
    randomIndependent:  { ko: "중복 허용", en: "Independent" },
    randomNoRepeat:     { ko: "연속 중복 없음", en: "No repeat" },
    randomShuffleBag:   { ko: "모두 사용", en: "Use all" },
    randomNext:         { ko: "다음", en: "Next" },
  ...
  scoreMode: {
    ...
    drumRideBell:       { ko: "라이드 벨", en: "Ride Bell" },
    ...
    drumRimshot:        { ko: "림샷", en: "Rimshot" },
    drumSideStick:      { ko: "사이드 스틱", en: "Side Stick" },
    drumTomLow:         { ko: "로우 탐탐", en: "Low Tom" },
    drumKick:           { ko: "킥", en: "Kick" },
    drumFootHihat:      { ko: "풋 하이햇", en: "Foot Hi-Hat" },
    drumFootHihatOpen:  { ko: "풋 하이햇 오픈", en: "Foot Hi-Hat Open" },
    ...
    noteHeadDiamond:    { ko: "◆다이아몬드", en: "Diamond" },
  ...
  stageMode: {
    ...
    exitButton:            { ko: "종료", en: "Exit" },
    tapAgain:              { ko: "한 번 더 탭하면 종료", en: "Tap again to exit" },
    bpmLabel:              { ko: "BPM", en: "BPM" },
    currentPlaying:        { ko: "현재 재생 중", en: "Now playing" },
    nextPlaying:           { ko: "다음 재생", en: "Up next" },
    beatUnit:              { ko: "비트", en: "Beat" },
    subdivisionUnit:       { ko: "서브디비전 노트", en: "Subdivision notes" },
    emptyBeatPattern:      { ko: "비트 패턴", en: "Beat pattern" },
    emptyBeatHint:         { ko: "탭: 강세 변경 · 스와이프: 박자 수 변경", en: "Tap: accent · Swipe: beat count" },
    emptyApplyAll:         { ko: "모든 비트에 적용", en: "Apply to all beats" },
    emptySubdivisionHint:  { ko: "위로 끌어 원하는 비트에 서브디비전 지정", en: "Drag upward to assign subdivisions to a beat" },
    ...
    autoAdvanceHint:       { ko: "반복 항목 외 자동으로 다음 항목으로 이동", en: "Automatically move to the next item (except loops)" },
    countdown:             { ko: "카운트다운", en: "Countdown" },
    countdown0:            { ko: "없음", en: "Off" },
    theme:                 { ko: "테마", en: "Theme" },
    themeDark:             { ko: "어둡게", en: "Dark" },
    themeLight:            { ko: "밝게", en: "Light" },
    keepAwake:             { ko: "화면 켜두기", en: "Keep Awake" },
    scoreHighlight:        { ko: "악보 하이라이트 위치", en: "Score Highlight Position" },
    scoreHighlightTop:     { ko: "상단", en: "Top" },
    scoreHighlightCenter:  { ko: "중앙", en: "Center" },
    scoreHighlightBottom:  { ko: "하단", en: "Bottom" },
    pickerTitle:           { ko: "연습장에서 추가", en: "Add from Practice Book" },
    pickerEmpty:           { ko: "모든 항목이 이미 셋 리스트에 있습니다", en: "All items are already in the set list" },
    modeBeat:              { ko: "비트", en: "Beat" },
    modeBar:               { ko: "바", en: "Bar" },
  ...
  polygon: {
    ...
    deleteLayer:     { ko: "레이어 삭제", en: "Delete Layer" },
    sides:           { ko: "변 수", en: "Sides" },
    sidesCircle:     { ko: "원(펄스)", en: "Circle (Pulse)" },
    color:           { ko: "색상", en: "Color" },
    soundSet:        { ko: "사운드", en: "Sound" },
    role:            { ko: "역할", en: "Role" },
    high:            { ko: "강", en: "High" },
    low:             { ko: "약", en: "Low" },
    strong:          { ko: "강세", en: "Strong" },
    volume:          { ko: "볼륨", en: "Volume" },
    customSound:     { ko: "커스텀 사운드", en: "Custom Sound" },
    importAudio:     { ko: "오디오 가져오기", en: "Import Audio" },
    muteVertex:      { ko: "탭하여 음소거 전환", en: "Tap vertex to toggle mute" },
    offsetTitle:     { ko: "{{n}}번 꼭짓점 오프셋", en: "Vertex {{n}} Offset" },
    offsetHint:      { ko: "0% = 정박  /  50% = 스윙", en: "0% = on beat  /  50% = swing" },
    offsetReset:     { ko: "초기화", en: "Reset" },
    offsetConfirm:   { ko: "확인", en: "Confirm" },
    playing:         { ko: "재생 중", en: "Playing" },
    stopped:         { ko: "정지", en: "Stopped" },
    emptyHint:       { ko: "아래에서 레이어를 추가하세요", en: "Add a layer below" },
    editHint:        { ko: "꼭짓점을 길게 눌러 오프셋을 설정하세요", en: "Long-press a vertex to set offset" },
  },
  switcher: {
    beat:     { ko: "비트",  en: "Beat"  },
    bar:      { ko: "바",    en: "Bar"   },
    ...
    openDialHint: { ko: "모드 전환 다이얼을 엽니다", en: "Open the mode switcher dial" },
    closeDialHint: { ko: "메뉴 화면을 닫고 모드 전환으로 돌아갑니다", en: "Close the menu and return to the mode switcher" },
