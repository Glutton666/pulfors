...
function generateClassicHigh() {
  ...
  for (let i = 0; i < numSamples; i++) {
    ...
    const f0 = 2500 + 800 * Math.exp(-t * 300);
    let s = 0;
...
function generateClassicLow() {
  ...
  for (let i = 0; i < numSamples; i++) {
    ...
    const f0 = 1800 + 500 * Math.exp(-t * 350);
    let s = 0;
    s += Math.sin(2 * Math.PI * f0 * t) * 1.0;
...
function generateClassicStrong() {
  ...
  for (let i = 0; i < numSamples; i++) {
    ...
    const f0 = 3200 + 1200 * Math.exp(-t * 250);
    let s = 0;
    s += Math.sin(2 * Math.PI * f0 * t) * 1.0;
...
function generateWoodblockHigh() {
  ...
  for (let i = 0; i < numSamples; i++) {
    ...
    const f1 = 900 + 200 * Math.exp(-t * 100);
    const f2 = 2300 + 300 * Math.exp(-t * 120);
    let s = 0;
...
function generateWoodblockLow() {
  ...
  for (let i = 0; i < numSamples; i++) {
    const t = i / SAMPLE_RATE;
    const env = Math.exp(-t * 90);
    const f1 = 600 + 150 * Math.exp(-t * 80);
    const f2 = 1500 + 200 * Math.exp(-t * 100);
    let s = 0;
    s += Math.sin(2 * Math.PI * f1 * t) * 1.0;
...
function generateWoodblockStrong() {
  ...
  for (let i = 0; i < numSamples; i++) {
    ...
    const f1 = 1100 + 300 * Math.exp(-t * 80);
    const f2 = 2800 + 500 * Math.exp(-t * 100);
    let s = 0;
    s += Math.sin(2 * Math.PI * f1 * t) * 1.0;
